...
def process(ip_image):
    ...
    # for matrix in matrix1[0, :]:
    #     cv2.circle(ip_image, (matrix[0], matrix[1]), matrix[2], (255, 0, 0), 2)  #prints detected circles.
    ...
    # dist1 = math.sqrt((matrix1[0, 0, 0] - matrix1[0, 1, 0])**2 + (matrix1[0, 0, 1] - matrix1[0, 1, 1])**2) #a
    # dist2 = math.sqrt((matrix1[0, 0, 0] - matrix1[0, 2, 0])**2 + (matrix1[0, 0, 1] - matrix1[0, 2, 1])**2) #b
    # dist3 = math.sqrt((matrix1[0, 1, 0] - matrix1[0, 2, 0])**2 + (matrix1[0, 1, 1] - matrix1[0, 2, 1])**2) #c
    # angle = round((math.acos((dist1**2 + dist2**2 - dist3**2)/(2*dist1*dist2)))*(180/math.pi), 2)
